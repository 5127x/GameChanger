...
def steering_rotations(stop, threadKey, speed, rotations, steering):
    ...
    target_rotations = rotations * 360 # convert to rotations bcs its simpler
...
#steering_rotations(lambda:stopProcessing, threadKey = 0, speed = 10, rotations = 1, steering = 5)
